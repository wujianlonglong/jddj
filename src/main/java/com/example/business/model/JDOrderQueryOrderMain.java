...
public class JDOrderQueryOrderMain {
    ...
    /// </summary>
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", locale = "zh", timezone = "GMT+8")
    private Date orderPreDeliveryTime ;
    ...
    private List<JDOrderQueryOrderDiscount> orderDiscountList;

    public JDOrderQueryOrderMain()
    {
        ...
        orderProductList = new ArrayList<JDOrderQueryOrderProduct>();
        orderDiscountList = new ArrayList<JDOrderQueryOrderDiscount>();
    }
